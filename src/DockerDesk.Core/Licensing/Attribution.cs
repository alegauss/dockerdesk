...
public static class Attribution
{
    ...
    public const string Holder = "DockerDesk contributors";
    ...
    public const string Scope =
        "DockerDesk itself is Apache-2.0 and free at any headcount. "
    ...
    public static string Notice(EngineManifest manifest)
    {
        var text = new StringBuilder()
            ...
            .Append('\n')
            .Append("This product includes software developed by the DockerDesk contributors,\n")
    ...
    {
        var text = new StringBuilder()
            .Append("DockerDesk ").Append(version).Append('\n')
